  ...
  created: function created() {
    ...
    this.$on('add-layout', function (key) {
      ...
      for (var i = 0; i < layoutEntries.length; i++) {
        ...
        var layout_to_add = Object.assign({}, layout);
        items.push(layout_to_add);
      }

      _this.$nextTick(function () {
        _this.$emit('layout-added');
      });
    });
  },
  beforeDestroy: function beforeDestroy() {
...
var GridLayout_component = normalizeComponent(
  ...
  GridLayoutvue_type_template_id_0449df68_render,
  GridLayoutvue_type_template_id_0449df68_staticRenderFns,
  false,
  null,
  null,
  null
